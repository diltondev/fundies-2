        ...
        "sites": [
            {
                "Id": "10",
                "Name": "Site 1",
                "Description": "A site with valid data",
                "Longitude": 1.0,
                "Latitude": 1.0,
                "Status": "active",
            },
            {
                "Id": "Not an int",
                "Name": "Site 2",
                "Description": "A site with invalid ID",
                "Longitude": 2.0,
                "Latitude": 2.0,
                "Status": "inactive",
            },
            {
                "Id": "30",
                "Name": "",
                "Description": "A site with empty name",
                "Longitude": 3.0,
                "Latitude": 3.0,
                "Status": "active",
            },
            ...
            },
            {
                "Id": "50",
                "Name": "Site 5",
                "Description": "A site with invalid coordinates",
                "Longitude": 0.0,
                "Latitude": 0.0,
                "Status": "active",
            },
            {
                "Id": "60",
                "Name": "Site 6",
                "Description": "A site with empty status",
                "Longitude": 6.0,
                "Latitude": 6.0,
                "Status": "",
            },
...
class TestFifteenMinuteObservation:
    ...
    def test_end_time_minutes_in_day(self, normal_fifteen_minute_observation):
        ...
        assert observation.end_time_minutes_in_day == 14
        expected_minutes = (
            observation.end_datetime.hour * 60 + observation.end_datetime.minute
        )
...
class TestDailyReportRequest:
    ...
    def test_protected_properties(self):
        rr = DailyReportRequest(
            1, datetime.now().replace(hour=0, minute=0, second=0, microsecond=0)
        )
...
class TestSite:
    ...
    def test_get_average_speed(self, mock_report_request_send, normal_site):
        ...
        total_weighted_speed = (
            66.2 * 172 + 65.0 * 136 + 64.5 * 150 + 64.0 * 100 + 60.0 * 100
        )
    ...
    def test_get_records_for_hour_out_of_range(
        self, mock_report_request_send, normal_site
    ):
        mock_report_request_send.return_value = normal_site.get_observations_list()
        with pytest.raises(ValueError):
